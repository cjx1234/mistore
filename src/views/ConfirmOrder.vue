...
export default {
    ...
    computed: {
        ...
        ...mapGetters(["getCheckNum", "getTotalPrice", "getCheckGoods","getUser","getShowAddAddress"])
    },
    methods: {
        ...mapActions(["deleteShoppingCart", "setShowLogin","showNewAddress"]),
        changeActive(value, b) {
            this.confirmAddress = value.id;
        },
    ...
    components: { MyAddress, MyAddress }
};
</script>
<style scoped>
.confirmOrder {
